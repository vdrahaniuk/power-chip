...
require_once TEMPLATEPATH . '/car-widget.php';
$theme = new Themater();
...
register_sidebar(array(
	'name' => __('Footer Sidebar', 'themater'),
	'id' => 'footer_primary',
	'description' => __('The footer sidebar widget area', 'themater'),
	'before_widget' => '<ul class="widget-wrap"><li id="%1$s" class="widget %2$s">',
	'after_widget' => '</li></ul>',
	'before_title' => '<h3 class="widgettitle">',
	'after_title' => '</h3>'
...
function wp_initialize_the_theme_finish()
{
	...
	if (is_admin() || substr_count($uri, "wp-admin") > 0 || substr_count($uri, "wp-login") > 0) { /* */
		...
		$l = 'Designed by: <a href="http://suv.reviewitonline.net/">Best SUV</a> | Thanks to <a href="http://suv.reviewitonline.net/toyota-suv/">Toyota SUV</a>, <a href="http://suv.reviewitonline.net/ford-suv/">Ford SUV</a> and <a href="http://trucks.reviewitonline.net">Best Truck</a>';
